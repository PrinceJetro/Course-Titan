"""
Django settings for coursetitans project.
...
SECRET_KEY = 'django-insecure-ce0@xw@ek*#a)w6v#9&z%*$abh)x5e2qy+a=f3tk4yz*!l8*9+'
...
ROOT_URLCONF = 'coursetitans.urls'
...
WSGI_APPLICATION = 'coursetitans.wsgi.application'
